<!--   Core JS Files   -->
<script src="{{ asset('template/js/jquery-3.1.1.min.js') }}" type="text/javascript"></script>
...
<script src="{{ asset('template/js/material.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('template/js/perfect-scrollbar.jquery.min.js') }}" type="text/javascript"></script>
...
<!--  Charts Plugin -->
<script src="{{ asset('template/js/chartist.min.js') }}"></script>
<!--  Plugin for the Wizard -->
<script src="{{ asset('template/js/jquery.bootstrap-wizard.js') }}"></script>
...
<!-- Vector Map plugin -->
<script src="{{ asset('template/js/jquery-jvectormap.js') }}"></script>
<!-- Sliders Plugin -->
<script src="{{ asset('template/js/nouislider.min.js') }}"></script>
<!--  Google Maps Plugin    -->
<script src="https://maps.googleapis.com/maps/api/js"></script>
<!-- Select Plugin -->
<script src="{{ asset('template/js/jquery.select-bootstrap.js') }}"></script>
...
<script src="{{ asset('template/js/jasny-bootstrap.min.js') }}"></script>
<!--  Full Calendar Plugin    -->
<script src="{{ asset('template/js/fullcalendar.min.js') }}"></script>
<!-- TagsInput Plugin -->
<script src="{{ asset('template/js/jquery.tagsinput.js') }}"></script>
